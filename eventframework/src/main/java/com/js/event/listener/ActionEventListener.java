...
public class ActionEventListener implements EventListener<BaseEvent<String, String[]>> {

	public void onEvent(BaseEvent<String, String[]> event, EventContext context) throws EventException {
		System.out.println("ActionEventListener handling event of type " + event.getEventType());
