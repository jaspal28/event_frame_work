...
public class EventInterruptNotificationException extends EventException {
	/**
	 * Serial version ID
	 */
	 ...
	 */
	public EventInterruptNotificationException(Event<?, ?> event) {
		super(event);
	}
	 ...
	 * @param event     original event object
	 */
	public EventInterruptNotificationException(Throwable throwable, Event<?, ?> event) {
	 ...
	 * @param event   original event object
	 */
	public EventInterruptNotificationException(String message, Event<?, ?> event) {
		super(message, event);
	}
	 ...
	 * @param event     original event object
	 */
	public EventInterruptNotificationException(String message, Throwable throwable, Event<?, ?> event) {
	 ...
	 * @param event              original event object
	 */
	public EventInterruptNotificationException(String message, Throwable cause, boolean enableSuppression,
